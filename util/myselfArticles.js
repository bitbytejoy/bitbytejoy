export default [
  {
    ...
    text: [
      ...
      "While developing the software behind the designs, I try to write the shortest and simplest code possible. This leads to the code being easier to maintain, and easier to introduce to new developers who are picking it up after in the maintenance phase.",
      "I am constantly trying new technologies and I am evaluating them in my spare time. Most of my clients value time as much as they value quality. That is why it is even more important for me to stay updated on newest technologies and to possess the knowledge that gives my clients shorter development cycles with clean codebases and simple user friendly designs."
    ],
    expanded: false
  },
  {
    ...
    text: [
      ...
      "Why do I do this?",
      "During a long period of working on many projects for a many clients with different backgrounds, I have gained insight into the problems that startups and companies face. These problems are usually caused by the technologies they choose to work with. It has happened, more often than I expected, that a client asked for a specific technology, with no insight if it was the right tool for the job. Sometimes it was the right technology and sometimes it was not."
    ],
    expanded: false
  },
  {
    ...
    text: [
      ...
      "All my experience has thought me a thing or two. I have become a biased developer with strong opinions on technologies. Some technologies I do not consider worthy of working on anymore and will not accept a job for. The reason for this is that I have seen what those technologies do to projects and how much the technologies prolongate something that could have been done a lot easier and faster with more happy customers and even more satisfied developers.",
      "My biggest love would be C. The only programming language that will forever remain the father of all other.",
      "The web technologies that I love to work with are: MongoDB/MySQL, Redis, Express/Java Spark, Next.js & React."
    ],
    expanded: false
  },
  {
